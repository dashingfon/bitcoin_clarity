    ...
    const block = chain.mineBlock([
      Tx.contractCall(
        ...
        [
          ...
          types.tuple({
            version: types.buff(hexToBytes("00")),
            parent: types.buff(hexToBytes("00")),
            "merkle-root": types.buff(hexToBytes("00")),
            timestamp: types.buff(hexToBytes("00")),
            nbits: types.buff(hexToBytes("00")),
            nonce: types.buff(hexToBytes("00")),
          }),
          types.tuple({
